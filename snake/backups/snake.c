...
{
	SetPos(X2 + 6, 30);
	color(116); printf("研发者：CSDN博主-敲上瘾"); color(112);
}
int menu2()
{
	...
	wprintf(L"%lc", L'→');
	SetPos(36, 10);
	printf("***** "); color(124); printf("1.单人模式 "); color(112); printf("******");
	SetPos(36, 11);
	printf("***** "); color(121); printf("2.双人博弈 "); color(112); printf("******");
	SetPos(36, 13);
	printf("请选择>>");
	return 2;
}
...
int Menu()
{
	...
	int x = 1;
	SetPos(36, 9);
	printf("****"); color(122); printf("$$>*********<$$"); color(112); printf("****");
	SetPos(36, 12);
	printf("****"); color(122); printf("$$>*********<$$"); color(112); printf("****");
	if (Key(13))
		Sleep(200);
